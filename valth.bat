...
title "Nick's Script v!script_version!"
set "mode=0"
...
if "%~1"=="run" (
    ...
    set "mode=1"
    title "Nick's Script v!script_version! (with user perms for controller)"
    echo.
) else if "%~1"=="run_radar" (
    set "mode=2"
    title "Nick's Script v!script_version! Radar Version obsolete ;)"
    mode 95, 40
    echo.
) else (
    mode 85, 30
...
set "tab=    "
echo.
echo.%tab%    ...Downloading necessary files...
call :downloadFileWithFallback "%controllerUrl%" "%baseRunnerDownloadUrl%controller.exe" "controller.exe"
call :downloadFile "%baseDownloadUrl%valthrun-driver.sys" "trump-driver.sys"
...
kdmapper.exe trump-driver.sys > %file%
...
if "%ERRORLEVEL%"=="0" (
    echo.
    echo   CS2 is running. Trump will protect you.
    echo.
) else (
    echo.
...
echo.
:::[1[37m                                                  [31m   [37m                              
:::[1[31m ____________________ ____ ___  _____ __________  _______________   ________    _____   [1[
:::[1[31m \__    ___|______   \    |   \/     \\______   \ \_____  \   _  \  \_____  \  /  |  |  [1[
:::[1[37m   |    |   |       _/    |   /  \ /  \|     ___/  /  ____/  /_\  \  /  ____/ /   |  |_ [1[
:::[1[37m   |    |   |    |   \    |  /    Y    \    |     /       \  \_/   \/       \/    ^   / [1[
:::[1[34m   |____|   |____|_  /______/\____|__  /____|     \_______ \_____  /\_______ \____   |  [1[
:::[1[34m                   \/                \/                   \/     \/         \/    |__|  [1[  
...
set "errAutoFixFailed=Trumps's Script tried to auto-fix it but failed"
